...
class ReluPytorch(base_operator.ReluBase):
    def __init__(self, inputs:list=[], outputs:list=[]):
        inputs_list = [data.numpy() for data in inputs]
        outputs_list = [data.numpy() for data in outputs]
        inputs_layout_list = [operator_pb2.LAYOUT_NCHW]
...
# class SinPytorch(base_operator.SinBase):
#     def __init__(self, inputs:list=[], outputs:list=[]):
#         inputs_list = [data.numpy() for data in inputs]
#         outputs_list = [data.numpy() for data in outputs]
#         inputs_layout_list = [operator_pb2.LAYOUT_NCHW]
...
#         return inputs, outputs
# 
# class CosPytorch(base_operator.CosBase):
#     def __init__(self, inputs:list=[], outputs:list=[]):
#         inputs_list = [data.numpy() for data in inputs]
#         outputs_list = [data.numpy() for data in outputs]
#         inputs_layout_list = [operator_pb2.LAYOUT_NCHW]
...
#         return inputs, outputs
# 
# class TanPytorch(base_operator.TanBase):
#     def __init__(self, inputs:list=[], outputs:list=[]):
#         inputs_list = [data.numpy() for data in inputs]
#         outputs_list = [data.numpy() for data in outputs]
#         inputs_layout_list = [operator_pb2.LAYOUT_NCHW]
...
#         return inputs, outputs
# 
# class ASinPytorch(base_operator.ASinBase):
#     def __init__(self, inputs:list=[], outputs:list=[]):
#         inputs_list = [data.numpy() for data in inputs]
#         outputs_list = [data.numpy() for data in outputs]
#         inputs_layout_list = [operator_pb2.LAYOUT_NCHW]
...
#         return inputs, outputs
# 
# class ACosPytorch(base_operator.ACosBase):
#     def __init__(self, inputs:list=[], outputs:list=[]):
#         inputs_list = [data.numpy() for data in inputs]
#         outputs_list = [data.numpy() for data in outputs]
#         inputs_layout_list = [operator_pb2.LAYOUT_NCHW]
...
#         return inputs, outputs
# 
# class ATanPytorch(base_operator.ATanBase):
#     def __init__(self, inputs:list=[], outputs:list=[]):
#         inputs_list = [data.numpy() for data in inputs]
#         outputs_list = [data.numpy() for data in outputs]
#         inputs_layout_list = [operator_pb2.LAYOUT_NCHW]
...
#         return inputs, outputs
# 
# class SinHPytorch(base_operator.SinHBase):
#     def __init__(self, inputs:list=[], outputs:list=[]):
#         inputs_list = [data.numpy() for data in inputs]
#         outputs_list = [data.numpy() for data in outputs]
#         inputs_layout_list = [operator_pb2.LAYOUT_NCHW]
...
#         return inputs, outputs
# 
# class CosHPytorch(base_operator.CosHBase):
#     def __init__(self, inputs:list=[], outputs:list=[]):
#         inputs_list = [data.numpy() for data in inputs]
#         outputs_list = [data.numpy() for data in outputs]
#         inputs_layout_list = [operator_pb2.LAYOUT_NCHW]
...
#         return inputs, outputs
# 
# class TanHPytorch(base_operator.TanHBase):
#     def __init__(self, inputs:list=[], outputs:list=[]):
#         inputs_list = [data.numpy() for data in inputs]
#         outputs_list = [data.numpy() for data in outputs]
#         inputs_layout_list = [operator_pb2.LAYOUT_NCHW]
...
#         return inputs, outputs
# 
# class ASinHPytorch(base_operator.ASinHBase):
#     def __init__(self, inputs:list=[], outputs:list=[]):
#         inputs_list = [data.numpy() for data in inputs]
#         outputs_list = [data.numpy() for data in outputs]
#         inputs_layout_list = [operator_pb2.LAYOUT_NCHW]
...
#         return inputs, outputs
# 
# class ACosHPytorch(base_operator.ACosHBase):
#     def __init__(self, inputs:list=[], outputs:list=[]):
#         inputs_list = [data.numpy() for data in inputs]
#         outputs_list = [data.numpy() for data in outputs]
#         inputs_layout_list = [operator_pb2.LAYOUT_NCHW]
...
#         return inputs, outputs
# 
# class ATanHPytorch(base_operator.ATanHBase):
#     def __init__(self, inputs:list=[], outputs:list=[]):
#         inputs_list = [data.numpy() for data in inputs]
#         outputs_list = [data.numpy() for data in outputs]
#         inputs_layout_list = [operator_pb2.LAYOUT_NCHW]
