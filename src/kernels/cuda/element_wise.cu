...
template <class T>
__global__ void _greater_kernel(void *x, void *y, float *z, int a0, int a1,
...
template <class T>
__global__ void _greater_or_equal_kernel(void *x, void *y, float *z, int a0,
...
void greater_kernel(int dType, void *a, void *b, float *c, int a0, int a1,
...
void greater_or_equal_kernel(int dType, void *a, void *b, float *c, int a0,
