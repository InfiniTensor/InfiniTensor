...
void bangRMSNormFp32(const Shape &inputShape, const vector<float> &inputData,
                     const Shape &weightShape, const vector<float> &weightData, const vector<float> &expectData) {
    // Runtime
...
TEST(bangRMSNormFp32, run) {
    bangRMSNormFp32(
        ...
        Shape{2}, vector<float>{1.,  2.}, vector<float>{0.000000, 2.828399, 0.784464, 2.353392, 0.883452, 2.208630, 0.920358,
        2.147502, 0.939552, 2.113993, 0.951303, 2.092867, 0.959233, 2.078338,
        0.964944, 2.067737, 0.969252, 2.059661, 0.972618, 2.053304, 0.975320,
        2.048172, 0.977536, 2.043940});
