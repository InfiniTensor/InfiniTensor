...
TEST(cnnlSoftmaxFp32, run) {
    ...
    cnnlSoftmaxFp32(
        ...
        1, vector<float>{0.0179862, 0.0179862, 0.0179862, 0.0179862, 0.9820138, 0.9820138,
    ...
    cnnlSoftmaxFp32(
        ...
        2, vector<float>{0.1192029, 0.1192029, 0.8807971, 0.8807971, 0.1192029, 0.1192029,
    ...
    cnnlSoftmaxFp32(
        ...
        3, vector<float>{0.2689414, 0.7310586, 0.2689414, 0.7310586, 0.2689414, 0.7310586,
        0.2689414, 0.7310586, 0.2689414, 0.7310586, 0.2689414, 0.7310586,
        0.2689414, 0.7310586, 0.2689414, 0.7310586});                     
    cnnlSoftmaxFp32(
        Shape{2, 4}, vector<float>{0., 1., 2., 3., 1000, 1001, 1002, 1003}, 0,
